...
if __name__ == '__main__':
    ...
    parser.add_argument('--file_path', type=str, default='./outputs/example-fp_growth-0.1-0.3.csv')
    parser.add_argument('--reference_path', type=str, default='./outputs/example-fp_growth-0.1-0.4.csv')
